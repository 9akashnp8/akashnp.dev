...
<article class="prose prose-stone dark:prose-invert">
    ...
    Here the full app: [learn-server-sent-events](https://github.com/9akashnp8/learn-server-sent-events). Contains bonus implementation of SSE in React as well.
